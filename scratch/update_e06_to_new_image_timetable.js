...
async function updateE06ToNewImageTimetable() {
  const client = await db.pool.connect();
  try {
    console.log('================================================================');
    console.log('=== UPDATING DEPT E06 TIMETABLE TO THE REVISED FACULTY SCHEDULE ===');
    console.log('================================================================\n');
    ...
    // 4. Exact Timetable Grid from Newly Uploaded Image (42 Slots)
    const newImageGrid = [
      // MONDAY
    ...
    for (const slot of newImageGrid) {
    ...
    console.log(`✓ Installed 42 period slots for E06 matching the updated timetable image.`);

    await client.query('COMMIT');
    console.log('\n================================================================');
    console.log('=== E06 TIMETABLE UPDATE TO REVISED IMAGE COMPLETED SUCCESSFUL ===');
    console.log('================================================================');
